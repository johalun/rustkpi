...
pub const PCI_PNP_STR: &'static [u8; 93usize] =
    b"M16:mask;U16:vendor;U16:device;U16:subvendor;U16:subdevice;U16:class;U16:subclass;U16:revid;\x00";
...
pub struct pci_device_table {
    ...
    pub descr: *mut ::kernel::sys::raw::c_char,
}
#[test]
fn bindgen_test_layout_pci_device_table() {
    assert_eq!(::core::mem::size_of::<pci_device_table>() , 40usize , concat !
               ( "Size of: " , stringify ! ( pci_device_table ) ));
    assert_eq! (::core::mem::align_of::<pci_device_table>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( pci_device_table ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . vendor as * const
                _ as usize } , 2usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( vendor ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . device as * const
                _ as usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( device ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . subvendor as *
                const _ as usize } , 6usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( subvendor ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . subdevice as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( subdevice ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . class_id as *
                const _ as usize } , 10usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( class_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . subclass as *
                const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( subclass ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . revid as * const _
                as usize } , 14usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( revid ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . unused as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( unused ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . driver_data as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( driver_data ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const pci_device_table ) ) . descr as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( pci_device_table ) ,
                "::" , stringify ! ( descr ) ));
}
impl Clone for pci_device_table {
    fn clone(&self) -> Self { *self }
}
impl Default for pci_device_table {
    fn default() -> Self { unsafe { ::core::mem::zeroed() } }
}
impl pci_device_table {
    #[inline]
    pub fn match_flag_vendor(&self) -> u16 {
    ...
    #[inline]
    pub fn set_match_flag_vendor(&mut self, val: u16) {
        let mask = 1u64 as u16;
    ...
    #[inline]
    pub fn match_flag_device(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_device(&mut self, val: u16) {
        let mask = 2u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn match_flag_subvendor(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_subvendor(&mut self, val: u16) {
        let mask = 4u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn match_flag_subdevice(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_subdevice(&mut self, val: u16) {
        let mask = 8u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn match_flag_class(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_class(&mut self, val: u16) {
        let mask = 16u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn match_flag_subclass(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_subclass(&mut self, val: u16) {
        let mask = 32u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn match_flag_revid(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_revid(&mut self, val: u16) {
        let mask = 64u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn match_flag_unused(&self) -> u16 {
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
            ::core::ptr::copy_nonoverlapping(&self._bitfield_1 as *const _ as
                                                 *const u8,
    ...
    #[inline]
    pub fn set_match_flag_unused(&mut self, val: u16) {
        let mask = 65408u64 as u16;
        let val = val as u16 as u16;
        let mut unit_field_val: u16 = unsafe { ::core::mem::uninitialized() };
        unsafe {
    ...
    #[inline]
    pub fn new_bitfield_1(match_flag_vendor: u16, match_flag_device: u16,
                          match_flag_subvendor: u16,
                          match_flag_subdevice: u16, match_flag_class: u16,
                          match_flag_subclass: u16, match_flag_revid: u16,
                          match_flag_unused: u16) -> u16 {
        ({
             ({
                  ({
                       ({
                            ({
                                 ({
                                      ({
                                           ({ 0 } |
                                                ((match_flag_vendor as u16 as
                                                      u16) << 0usize) &
                                                    (1u64 as u16))
                                       } |
                                           ((match_flag_device as u16 as u16)
                                                << 1usize) & (2u64 as u16))
                                  } |
                                      ((match_flag_subvendor as u16 as u16) <<
                                           2usize) & (4u64 as u16))
                             } |
                                 ((match_flag_subdevice as u16 as u16) <<
                                      3usize) & (8u64 as u16))
                        } |
                            ((match_flag_class as u16 as u16) << 4usize) &
                                (16u64 as u16))
                   } |
                       ((match_flag_subclass as u16 as u16) << 5usize) &
                           (32u64 as u16))
              } |
                  ((match_flag_revid as u16 as u16) << 6usize) &
                      (64u64 as u16))
         } |
             ((match_flag_unused as u16 as u16) << 7usize) &
                 (65408u64 as u16))
    }
}
extern "C" {
    pub fn pci_match_device(child: device_t, id: *const pci_device_table,
                            nelt: usize) -> *const pci_device_table;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cdevsw {
