...
pub type modeventhand_t =
    ::std::option::Option<unsafe extern "C" fn(arg1: module_t,
...
fn bindgen_test_layout_moduledata() {
    assert_eq!(::std::mem::size_of::<moduledata>() , 24usize , concat ! (
               "Size of: " , stringify ! ( moduledata ) ));
    assert_eq! (::std::mem::align_of::<moduledata>() , 8usize , concat ! (
...
fn bindgen_test_layout_modspecific() {
    assert_eq!(::std::mem::size_of::<modspecific>() , 8usize , concat ! (
               "Size of: " , stringify ! ( modspecific ) ));
    assert_eq! (::std::mem::align_of::<modspecific>() , 8usize , concat ! (
...
impl ::std::fmt::Debug for modspecific {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
...
fn bindgen_test_layout_mod_depend() {
    assert_eq!(::std::mem::size_of::<mod_depend>() , 12usize , concat ! (
               "Size of: " , stringify ! ( mod_depend ) ));
    assert_eq! (::std::mem::align_of::<mod_depend>() , 4usize , concat ! (
...
fn bindgen_test_layout_mod_version() {
    assert_eq!(::std::mem::size_of::<mod_version>() , 4usize , concat ! (
               "Size of: " , stringify ! ( mod_version ) ));
    assert_eq! (::std::mem::align_of::<mod_version>() , 4usize , concat ! (
...
fn bindgen_test_layout_mod_metadata() {
    assert_eq!(::std::mem::size_of::<mod_metadata>() , 24usize , concat ! (
               "Size of: " , stringify ! ( mod_metadata ) ));
    assert_eq! (::std::mem::align_of::<mod_metadata>() , 8usize , concat ! (
...
fn bindgen_test_layout_mod_pnp_match_info() {
    assert_eq!(::std::mem::size_of::<mod_pnp_match_info>() , 32usize , concat
               ! ( "Size of: " , stringify ! ( mod_pnp_match_info ) ));
    assert_eq! (::std::mem::align_of::<mod_pnp_match_info>() , 8usize , concat
...
fn bindgen_test_layout_module_stat() {
    assert_eq!(::std::mem::size_of::<module_stat>() , 56usize , concat ! (
               "Size of: " , stringify ! ( module_stat ) ));
    assert_eq! (::std::mem::align_of::<module_stat>() , 8usize , concat ! (
...
impl ::std::fmt::Debug for module_stat {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f ,
